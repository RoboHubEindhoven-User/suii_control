...
from suii_task_executor.states.manipulation_states import *
from suii_task_executor.states.navigation_state import *
...
class TaskExecutor:
    def __init__(self, name, age):
        ...
        # set default state
        self.fsm.set_state(StateName.TASKSELECT)
