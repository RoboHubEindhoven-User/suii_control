...
class State(object):
    ...
    def enter(self):
        ...
        rospy.loginfo ('Processing current state: ' + str(self.__str__()) + '...')
    ...
    def execute(self):
        ...
        rospy.loginfo ('Executing current state: ' + str(self.__str__()) + '...')

    def exit(self):
        ''' Used to process post-conditions of the state '''
        rospy.loginfo ('--> Exiting current state: ' + str(self.__str__()))
