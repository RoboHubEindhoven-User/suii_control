...
class SuiiRefBoxClient
{
    public:
        /**
         * Ctor.
         */
        SuiiRefBoxClient(const ros::NodeHandle &nh);
    ...
    private:
         ...
         * Copy Ctor.
         */
        SuiiRefBoxClient(const SuiiRefBoxClient &other);

        /**
         * Assignment operator
         */
        SuiiRefBoxClient &operator=(const SuiiRefBoxClient &other);
        ...
        void printTaskInfo(const atwork_ros_msgs::Task &task);
        void printNavigationInfo(const atwork_ros_msgs::Task &task);

        std::string getLocationIdentifierStr(std_msgs::UInt64 type);
        std::string getObjectTypeStr(std_msgs::UInt64 type);
        std::string getNavigationTypeStr(std_msgs::UInt64 type);
        std::string getNavOrientationTypeStr(std_msgs::UInt64 orientation);
